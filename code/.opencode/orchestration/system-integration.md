...
| Type | Where | Example |
|------|-------|---------|
| Quick decision | `code/.opencode/autosave/` | "Use CSS Grid for layout" |
| Complex analysis | `code/.opencode/autosave/resu.md` | "API response shape: {items[], total}" |
| Design output | `code/.opencode/autosave/resu.md#section` | 3 figma images + CSS blueprint |
| Code output | `code/.opencode/autosave/resu.md#section` | TypeScript types + endpoint |
...
| `code/.opencode/autosave/` | Quick notes per session | Current session state |
...
3. **Memory duty**: Every 5-10 messages
   - Extract decisions → code/.opencode/autosave/
   - Extract artifacts → code/.opencode/autosave/resu.md
   - Link them together
