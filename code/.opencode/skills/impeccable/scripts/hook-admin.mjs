...
const HOOK_MANIFEST_TARGETS = [
  ...
  {
    provider: '.agents',
    skillRel: 'code/.opencode/skills/impeccable',
    ...
    manifest: () => ({
      hooks: {
        PostToolUse: [
          {
            ...
            hooks: [
              {
                type: 'command',
                command: 'node ".opencode/skills/impeccable/scripts/hook.mjs"',
                timeout: TIMEOUT_SECONDS,
                statusMessage: STATUS_MESSAGE,
              },
            ],
        ...
        Stop: [stopManifestEntry('node ".opencode/skills/impeccable/scripts/hook.mjs"')],
      },
    }),
  },
  {
