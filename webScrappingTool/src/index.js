    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            return products.map((product) => {
                ...
                const precio = parsePrice((_a = product.price) !== null && _a !== void 0 ? _a : '');
                const oferta = product.price1 && parseFloat(String(product.price1)) > parseFloat(String((_b = product.price) !== null && _b !== void 0 ? _b : 0)) ? 'true' : '';
                const image = product.mainImage ? `${MARTINA_IMAGE_BASE}${product.mainImage}` : '';
                const categoryName = String(((_d = (_c = product.productLine) === null || _c === void 0 ? void 0 : _c.parent) === null || _d === void 0 ? void 0 : _d.name) || ((_e = product.productLine) === null || _e === void 0 ? void 0 : _e.name) || 'Ropa');
                const subcategoria = String(((_f = product.productLine) === null || _f === void 0 ? void 0 : _f.name) || '');
                return {
                    id: `mdt-${product.id}`,
                    relacionados: '',
                    name,
