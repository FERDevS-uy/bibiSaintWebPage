...
- **Delivery boundary:** feature-branch-chain remains future-only with `impladmin` as its target. No commit, PR, push, deploy, or archived/prior-draft mutation was made. Future commits must remain small, detailed, and reviewable.
